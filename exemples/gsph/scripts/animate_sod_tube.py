...
fig.suptitle('GSPH Sod Shock Tube - Comparison with Analytical Solution',
...
def update(frame_num):
    ...
    # Add time label
    fig.suptitle(f'GSPH Sod Shock Tube - t = {time:.4f}\n'
...
if len(frame_data) > 0:
    ...
    fig2.suptitle(f'GSPH Sod Shock Tube - Final State (t = {time:.4f})\n'
